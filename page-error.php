            ...
            <div class="thanks">
                <div class="thanks__title">
                    <div class="thanks__title-box">
                        <img src="<?php echo get_template_directory_uri() ?>/assests/img/error.png" alt="" class="thanks__images">
                    </div>
                    <span>Ошибка</span>
                </div>
                <div class="thanks__subtitle">Что-то пошло не так. Попробуйте отправить форму ещё раз.</div>
